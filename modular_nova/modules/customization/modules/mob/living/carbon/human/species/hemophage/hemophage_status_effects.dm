...
#define HEMOKINETIC_REGEN_BLOOD_CONSUMPTION 1 // Celadon EDIT, original: #define HEMOKINETIC_REGEN_BLOOD_CONSUMPTION 0.25
/// How much damage per second is healed by hemokinetic regen
#define HEMOKINETIC_REGEN_HEALING 0.5 // Celadon EDIT, original: #define HEMOKINETIC_REGEN_HEALING 1.8
