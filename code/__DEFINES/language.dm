...
#define AVAILABLE_IN_TELECOMMS 16 // Celadon ADDITION, should be here to proper merge because that is binary operations (multiple each new by 2 from last one)
