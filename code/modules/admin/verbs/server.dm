...
ADMIN_VERB(delay_round_end, R_SERVER, "Delay Round End", "Prevent the server from restarting.", ADMIN_CATEGORY_SERVER) // Celadon REVERT OF NOVA'S CHARGE OF R_SERVER
