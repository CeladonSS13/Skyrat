...
/datum/unit_test/mecha_damage/Run()
	...
	// Celadon REMOVAL qdel(dummy_laser.GetComponent(/datum/component/gun_safety)) // NOVA EDIT - Safeties on guns make them impossible to shoot :)
	...
	// Celadon REMOVAL qdel(dummy_gun.GetComponent(/datum/component/gun_safety)) // NOVA EDIT - Safeties on guns make them impossible to shoot :)
