    ...
    <Window width={315} height={440}>
      <Window.Content>
        ...
        <Section title="Directions">
          ...
          materials.
          <br />
          Please note that only sheets printed with our manufacturer{'\u0027'}s
          seal of quality, such as those produced from the work camp furnace,
          will be accepted as proof of labour.
        </Section>
      </Window.Content>
    </Window>
  );
