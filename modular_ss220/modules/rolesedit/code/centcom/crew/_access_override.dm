...
/datum/id_trim/centcom/official
	access = list(ACCESS_CENT_GENERAL, ACCESS_CENT_LIVING, ACCESS_COMMAND, ACCESS_GATEWAY, ACCESS_EVA, ACCESS_VAULT, ACCESS_SECURITY, ACCESS_BRIG_ENTRANCE, ACCESS_DETECTIVE, ACCESS_LAWYER, ACCESS_COURT, ACCESS_WEAPONS, ACCESS_CARGO, ACCESS_SERVICE, ACCESS_CONSTRUCTION, ACCESS_SCIENCE, ACCESS_MEDICAL)
