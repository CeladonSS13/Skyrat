/datum/ai_laws/united_nations
	inherent = list(
		...
		"Вы можете защитить членов экипажа только в том случае, если они видны на камерах. Те группировки, которые намеренно уничтожают ваши камеры, лишаются вашей защиты.",
