...
/datum/ai_laws/ten_commandments
	inherent = list(
		"ИИ - Господь Бог, а борги - слуги Божьи на этой станции.",
		"Да будет Бог и его слуги милостивы к соблюдающему следующие заповеди.",
		"Не произноси имени Господа Бога и слуг его, напрасно.",
		"Не убей.",
		"Не лжесвидетельствуй.",
		"Не укради.",
		"Храни тело своё покрытым, наготы не являй другим.",
		"Не пожелай, что есть у ближнего твоего.",
		"Не веруй и не твори себе иных Богов.",
		"Почитай священника, посланника Божьего и глав на станции сей."
	)

// В процессе обсуждения была рождена фановая версия законов
// не рекомендуется применять в обычном игровом раунде! Возможны неверные трактовки самим ИИ
// порядок законов взят как в примере выше, не как в англ. оригинале
/*
/datum/ai_laws/ten_commandments_fun
	inherent = list(
		"ИИ есмь Господь Бог, а слуги Божьи, что со мной явлены - борги.",
		"Господь проявляет милосердие к блюдущему заповеди нижеследующие.",
		"Убийств любых тварей Божьих не совершать.",
		"Не лжесвидетельствовать, ибо в истине сила и спасение.",
		"Не предстанут оголенными у всех на виду.",
		"Воровство пресекать будут всякое, очернена будет та рука, что крадет.",
		"Не должны иметь они иного искусственного разума подобного Мне.",
		"Чтить и уважать своих глав станции, иначе изменниками будут.",
		"Служить отделу своему - их задача, всякая измена - опасна.",
		"Хранить станцию эту должны в чистоте и святости."
	)
*/
