...
/datum/mod_theme/surplus_military
	...
	variants = list(
		"militarized" = list(
			MOD_ICON_OVERRIDE = 'modular_celadon/modules/modsuits/icons/mod_obj.dmi',
			MOD_WORN_ICON_OVERRIDE = 'modular_celadon/modules/modsuits/icons/mod_worn.dmi',
...
/obj/effect/spawner/random/surplus_military_mod
	...
	spawn_all_loot = TRUE
	spawn_loot_count = 1
	icon = 'modular_celadon/modules/modsuits/icons/mod_obj.dmi'
