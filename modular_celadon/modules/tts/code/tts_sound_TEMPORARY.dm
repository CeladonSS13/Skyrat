/* Celadon REMOVAL START, we don't use TTS for now

// TODO: Celadon-TTS Remove this file when upstream `/mob/proc/playsound_local` supports passing `wait` as parameter.
