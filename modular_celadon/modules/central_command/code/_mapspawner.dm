...
/datum/controller/subsystem/mapping/loadWorld()
	...
	LoadGroup(FailedZsRat1984_interlink, "The Interlink", "map_files/generic", "CentCom_interlink_Celadon.dmm", default_traits = ZTRAITS_CENTCOM)
	...
	LoadGroup(FailedZsRat1984_centcom, "CentCom_Station", "map_files/generic", "CentCom_Celadon.dmm", default_traits = ZTRAITS_CENTCOM)
	...
	if(SSmapping.current_map.space_ruin_levels)
		...
		LoadGroup(FailedZsRat1984_syndicate, "The Syndicate Area", "RandomRuins/SpaceRuins/nova", "des_two_celadon.dmm", default_traits = list(ZTRAIT_LINKAGE = CROSSLINKED))
