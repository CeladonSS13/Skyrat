/obj/item/gun/ballistic/automatic/m16
	...
	burst_size = 3
	fire_delay = 2
	fire_sound = 'modular_celadon/modules/return_prs/gunsgalore/sound/guns/fire/m16_fire.ogg'
	fire_sound_volume = 50
	rack_sound = 'modular_celadon/modules/return_prs/gunsgalore/sound/guns/interact/sfrifle_cock.ogg'
	load_sound = 'modular_celadon/modules/return_prs/gunsgalore/sound/guns/interact/sfrifle_magin.ogg'
	load_empty_sound = 'modular_celadon/modules/return_prs/gunsgalore/sound/guns/interact/sfrifle_magin.ogg'
	eject_sound = 'modular_celadon/modules/return_prs/gunsgalore/sound/guns/interact/sfrifle_magout.ogg'
