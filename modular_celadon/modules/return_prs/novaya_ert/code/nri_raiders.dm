...
/obj/item/card/id/advanced/nri_police
	...
	icon = 'modular_celadon/modules/return_prs/novaya_ert/icons/card.dmi'
...
/area/shuttle/nri_police
	...
	ambient_buzz = 'modular_celadon/modules/return_prs/novaya_ert/sound/police/amb_ship_01.ogg'
	ambient_buzz_vol = 15
	ambientsounds = list('modular_celadon/modules/return_prs/novaya_ert/sound/police/alarm_radio.ogg',
						'modular_celadon/modules/return_prs/novaya_ert/sound/police/alarm_small_09.ogg',
						'modular_celadon/modules/return_prs/novaya_ert/sound/police/gear_loop.ogg',
						'modular_celadon/modules/return_prs/novaya_ert/sound/police/gear_start.ogg',
						'modular_celadon/modules/return_prs/novaya_ert/sound/police/gear_stop.ogg',
						'modular_celadon/modules/return_prs/novaya_ert/sound/police/intercom_loop.ogg')
...
/obj/machinery/porta_turret/syndicate/nri_police
	...
	shot_delay = 15
	faction = list(FACTION_NRI)
	icon = 'modular_celadon/modules/return_prs/novaya_ert/icons/turrets.dmi'
	...
	lethal_projectile_sound = 'modular_celadon/modules/return_prs/novaya_ert/sound/police/shell_out_tiny.ogg'
	stun_projectile_sound = 'modular_celadon/modules/return_prs/novaya_ert/sound/police/shell_out_tiny.ogg'
...
/obj/docking_port/mobile/pirate/nri_police
	...
	takeoff_sound = sound('modular_celadon/modules/return_prs/novaya_ert/sound/police/engine_ignit_int.ogg')
	landing_sound = sound('modular_celadon/modules/return_prs/novaya_ert/sound/police/env_ship_down.ogg')
