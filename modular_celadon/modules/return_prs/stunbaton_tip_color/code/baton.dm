/obj/item/melee/baton/security
	...
	lefthand_file = 'modular_celadon/modules/return_prs/stunbaton_tip_color/icons/security_lefthand.dmi'
	righthand_file = 'modular_celadon/modules/return_prs/stunbaton_tip_color/icons/security_righthand.dmi'
