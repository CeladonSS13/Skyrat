...
/obj/item/gun/ballistic/automatic/pistol/firefly
	...
	righthand_file = 'modular_celadon/modules/return_prs/sec_haul/icons/inhands/righthand.dmi'
	lefthand_file = 'modular_celadon/modules/return_prs/sec_haul/icons/inhands/lefthand.dmi'
	icon_state = "firefly"
