/obj/item/crowbar/freeman
	...
	icon = 'modular_celadon/modules/return_prs/black_mesa/icons/misc/freeman.dmi'
	icon_state = "crowbar"
	force = 35
	throwforce = 45
	toolspeed = 0.1
...
/obj/item/shield/riot/pointman/hecu
	...
	icon = 'modular_celadon/modules/return_prs/black_mesa/icons/misc/ballistic.dmi'
	worn_icon_state = "ballistic_worn"
	worn_icon = 'modular_celadon/modules/return_prs/black_mesa/icons/misc/ballistic.dmi'
	inhand_icon_state = "ballistic"
	lefthand_file = 'modular_celadon/modules/return_prs/black_mesa/icons/misc/ballistic_l.dmi'
	righthand_file = 'modular_celadon/modules/return_prs/black_mesa/icons/misc/ballistic_r.dmi'
	force = 14
	throwforce = 5
	throw_speed = 1
	throw_range = 1
