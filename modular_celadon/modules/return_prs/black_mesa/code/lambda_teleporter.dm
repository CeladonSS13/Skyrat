...
/datum/looping_sound/lambda
	mid_sounds = list('modular_celadon/modules/return_prs/black_mesa/sound/lc_mainbeam.ogg' = 1)
...
/obj/effect/bump_teleporter/lambda/teleport_action(atom/movable/target, turf/destination)
	...
	playsound(src, 'modular_celadon/modules/return_prs/black_mesa/sound/lc_teleport.ogg', 100)
